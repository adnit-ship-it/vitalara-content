        ...
        <div class="w-full flex flex-col py-20 pt-0 md:py-24 px-6 lg:px-0 max-w-[1056px]">
            ...
            <div class="mt-10">
                <h3 class="text-[20px] md:text-[32px] font-semibold">
                    ...
                    <span class="text-accentColor1">{{ intakeForm?.highlight || 'fast and easy with Medivora' }}</span>
                </h3>
            </div>
            <div v-for="(field, index) in intakeForm?.fields" :key="index" class="mt-6 md:pt-p flex flex-col gap-2">
